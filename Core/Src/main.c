...
In application's STM32G431RBTX_FLASH.ld change FLASH address to 0x8008000 as below

MEMORY
{
  RAM    (xrw)    : ORIGIN = 0x20000000,   LENGTH = 32K
  FLASH    (rx)    : ORIGIN = 0x8008000,   LENGTH = 112K
}

In application's system_stm32g4xx.c
1) uncomment #define USER_VECT_TAB_ADDRESS around line 110
2) modify
